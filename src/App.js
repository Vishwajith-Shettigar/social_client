...
function App() {
  ...
  useEffect(() => {
    const loll = async () => {
      console.log("doss");
      await randomSocket.current.emit("outFromRandomChat");
    };
    if (!isRandom) {
      console.log("calles");
      loll();
...
<Route
          ...
          <Route
            path="/login"
            element={
              user ? <Navigate to="/" /> : <Login setJwtToken={setJwtToken} />
            }
          ></Route>
          <Route
            path="/register"
          ...
          <Route
            path="/messenger"
            element={
              !user ? <Navigate to="/" /> : <Messenger socket={socket} />
            }
          ></Route>
