...
function Profile({isGlobal,setIsglobal,isRandom,setIsRandom,homeOnlineusers}) {

  const {mobile,showSidebar}=useContext(globalinfo)
  console.log(mobile,showSidebar)
...
if(cfile)
{
  console.log(cfile)
  const data= new FormData();
  const fileName=String(Date.now()+cfile.name);
...
<div className="ediv">
          ...
          <input type="text" className="einput" placeholder={user.desc || "write description"} ref={edisc}></input>
          </div>
          <div className="ediv">
          ...
          <input type="radio" className=" einputbutton radiocss" name="relation" value="single"/>single
          <input type="radio"  className=" einputbutton radiocss" name="relation" value="married"/>married
          <input type="radio"  className=" einputbutton radiocss" name="relation" value="dont want to disclose" />Dont want to disclose
          </div>
